...
def login_page(request):
    ...
    context={ 'page':page }
    return render(request, 'awwwards/login_register.html', context)
...
def profile(request,pk):
    ...
    return render(request, 'awwwards/profile.html', context)
...
def project_page(request,pk):
    ...
    return render(request, 'awwwards/project.html', context)
